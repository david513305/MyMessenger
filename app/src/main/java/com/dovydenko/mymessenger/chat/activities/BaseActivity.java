            ...
            authStateListener = firebaseAuth -> {
                try {
                    if (FirebaseAuth.getInstance().getCurrentUser() == null) {
                        if (getClass().getSimpleName().equalsIgnoreCase("LoginActivity") || getClass().getSimpleName().equalsIgnoreCase("RegisterActivity")  || getClass().getSimpleName().equalsIgnoreCase("ForgetPasswordActivity")) {
                        } else {
