...
public interface IConstants {
    ...
    String BROADCAST_DOWNLOAD_EVENT = "com.dovydenko.mymessenger.chat.activities.DOWNLOAD_EVENT";

    String PLAYING_DATA = "playing_data";
    String BROADCAST_PLAY_RECORDING_EVENT = "com.dovydenko.mymessenger.chat.activities.PLAY_RECORDING_EVENT";
