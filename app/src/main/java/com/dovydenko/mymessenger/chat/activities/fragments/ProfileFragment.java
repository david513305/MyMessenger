...
import static com.dovydenko.mymessenger.chat.activities.constants.IConstants.EXTRA_GROUP_MEMBERS;
import static com.dovydenko.mymessenger.chat.activities.constants.IConstants.EXTRA_IMAGEURL;
...
import static com.dovydenko.mymessenger.chat.activities.constants.IConstants.REF_GROUP_MEMBERS;
...
import static com.dovydenko.mymessenger.chat.activities.constants.IConstants.REF_UPLOAD;
...
import static com.dovydenko.mymessenger.chat.activities.constants.IConstants.TYPE_GOOGLE;
...
public class ProfileFragment extends BaseFragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        final String lblNul = getString(R.string.strUnspecified);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.hasChildren()) {
                    ...
                    txtGender.setText(strGender == GEN_NUL ? lblNul : strGender == GEN_UNSPECIFIED ? lblUnSpecified : strGender == GEN_MALE ? lblMale : lblFemale);
